...
import com.tsahaylu.www.adapter.MessageAdapter;
...
public class Activity_Message extends Activity implements OnRefreshListener,OnScrollListener {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		public void getMessages()
		{
			...
			com.tsahaylu.www.util.StringRequest stringRequest = new StringRequest(Request.Method.GET, requesturl, null, new Listener<String>(){
